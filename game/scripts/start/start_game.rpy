...
label start_game:
    ...
    # background change
    "You hurry off to the nearby park. It’s been a while but all it doesn’t seem that much has changed since you moved away."
    ...
    sam "Hey  %(playerName)s!"

    # p "{i}Should I tell Sam?{/i}" an example of a monologue
